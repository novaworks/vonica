...
function nova_scripts() {
	...
	$nova_js_vars = array(
		...
		'select_placeholder'        => esc_html__( 'Choose an option', 'vonica' ),
		'blog_pagination_type' 			=> Nova_OP::getOption('blog_pagination'),
		'load_more_btn'        			=> esc_html__( 'Load more', 'vonica' ),
		'read_more_btn'        			=> esc_html__( 'Read more', 'vonica' ),
		'read_less_btn'        			=> esc_html__( 'Read less', 'vonica' ),
