...
Kirki::add_field( 'vonica', array(
    'type'        => 'slider',
    'settings'    => 'site_width',
    'label'       => esc_html__( 'Site Width', 'vonica' ),
    'section'     => $section,
    'default'     => 1440,
    'priority'    => 10,
    'choices'     => array(
...
Kirki::add_field( 'vonica', array(
    ...
    'label'       => esc_html__( 'Site Preloader', 'vonica' ),
    'section'     => $section,
    'default'     => false,
    'priority'    => 10,
) );
...
Kirki::add_field( 'vonica', array(
    ...
    'label'       => esc_html__( 'Site Support List', 'vonica' ),
    'section'     => $section,
    'default'     => false,
    'priority'    => 10,
) );
...
Kirki::add_field( 'vonica', array(
    ...
    'label'       => esc_html__( 'Chat Link', 'vonica' ),
    'section'     => $section,
...
Kirki::add_field( 'vonica', array(
    ...
    'label'       => esc_html__( 'Phone Link', 'vonica' ),
    'section'     => $section,
    'default'     => 'https://themeforest.ticksy.com/',
    'priority'    => 10,
    'active_callback'    => array(
...
Kirki::add_field( 'vonica', array(
    ...
    'label'       => esc_html__( 'Email Address', 'vonica' ),
    'section'     => $section,
...
Kirki::add_section( 'global_popup', array(
    'title'          => esc_html__( 'Newsletter Popup', 'vonica' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'section'          => 'global',
) );
